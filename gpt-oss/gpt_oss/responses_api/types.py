...
# Use a simple string for the default reasoning effort to avoid enum serialization issues
...
class ReasoningConfig(BaseModel):
    effort: Literal["low", "medium", "high"] = REASONING_EFFORT_DEFAULT
...
class ResponsesRequest(BaseModel):
    ...
    # Default to None so simple requests don't trigger reasoning processing
